...
const Header = (props) => {
  ...
  let activeColor = "var(--darkTextColorDi)";
  let inActiveColor = "var(--darkTextColorDi)";
        ...
        */}
        ...
        <div className={classes.navigationMenu}>
	      ...
	      onClick={props.homeHandler}
            ...
            >
              <div className={classes.headerButtonText}>Home</div>
            </button>
           ...
           <div className={classes.headerButtonDiv}>
            ...
            >
               <div className={classes.headerButtonText}> What we do</div>
            </button>
          ...
          <div className={classes.headerButtonDiv}>
            ...
            >
              <div className={classes.headerButtonText}>Why us?</div>
            </button>
            <div
              className={classes.underlineDiv}
          ...
          <div className={classes.headerButtonDiv}>
            ...
            >
              <div className={classes.headerButtonText}>Product categories</div>
            </button>
            <div
              className={classes.underlineDiv}
        ...
        <div className={classes.navigationMenuMobile}>
          ...
          <div className={classes.headerButtonDiv}>
            <button
              ...
              style={actsButtonStyle}
            >
               <div className={classes.headerButtonText}>Services</div>
            </button>
          ...
          <div className={classes.headerButtonDiv}>
            <button
              ...
              style={newsButtonStyle}
            >
              <div className={classes.headerButtonText}>Products</div>
            </button>
            <div
              className={classes.underlineDiv}
              style={{ backgroundColor: newsButtonStyle.underlineColor }}
