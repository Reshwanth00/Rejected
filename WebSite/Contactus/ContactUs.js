      ...
      <div className={classes.contactUsParent}>
        <div className={classes.content}>
          ...
          <div className={classes.phoneContainer}>
            ...
            <div className={classes.phoneDetails}>+91 9167922518</div>
          </div>

          <div className={classes.emailContainer}>
            <BsFillEnvelopeFill className={classes.emailIcon} />
            <div className={classes.emailHead}>Email : </div>
            <div className={classes.emailDetails}> info@brandmyspares.com</div>
          </div>
          ...
          <div className={classes.getinTouchTitle}>
Connect with BrandMySpare
</div>

          <div className={classes.getintouchdetails3}>
          Welcome to the BrandMySpare Contact Us page! Whether you have inquiries, concerns, or feedback, we're here to assist you. Feel free to reach out using the details below:
          </div>
        </div>
...
{/* 
      ...
      <div className={classes.d1}>
        For general inquiries, please email us at: info@brandmyspares.com
      </div>
      ...
      <div className={classes.d1}>
        ...
        please contact our partnerships team at: info@brandmyspares.com
      </div>
      ...
      <div className={classes.d1}>
        ...
        please contact our technical support team at: info@brandmyspares.com
      </div>
      ...
      <div className={classes.d1}>
        ...
        for improvement, please let us know at: info@brandmyspares.com
      </div>

      <div className={classes.d2}>
        Thank you for choosing DiracAI. We look forward to hearing from
        you!
      </div> */}
    </div>
  );
