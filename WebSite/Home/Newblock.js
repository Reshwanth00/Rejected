    ...
    <div className={classes.threeCardContainer}>
      <div className={classes.card1}>
        <div className={classes.contentContainer}>
          ...
          <div className={classes.details}>
            We offer affordable  solutions that help you reduce your labeling costs  of auto-spare parts  and
      ...
      <div className={classes.card3}>
        <div className={classes.contentContainer}>
          ...
          <div className={classes.details}>
            We specialize in serving specific categories, such as tractor,
            cars, heavy vehicles and offer tailored solutions that meet
            your unique needs.
          </div>
        </div>
      </div>
