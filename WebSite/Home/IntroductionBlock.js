...
import firstBlockImage1 from './BMW.png';

import firstImage from './imageone.png';
    ...
    <div className={classes.MainIntroductionBlockParent}>
      ...
      <div className={classes.IntroductionBlockParent}>
        <div className={classes.leftBox}>
          <div className={classes.mainCard}>
            <div className={classes.mainheadings}>
              Crafting Excellence: Private Labeled Auto Spare Parts. 
            </div>

            <div className={classes.subHead}> Emphasizes the quality and craftsmanship involved in the private labeling process, instilling confidence in potential customers </div>
        ...
        <div className={classes.rightBox}>
          ...
          <img src={firstImage} className={classes.imgOneBig} />	  
	  {/* 	   
