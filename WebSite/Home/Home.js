...
const Home = (props) => {
  ...
  return (
    <div className={classes.homeParent}>
      ...
      <div className={classes.growVisionTitle}>
        <h2 style={{color: "var(--themeColor)"}}> Grow Your Vision </h2>  

	  <div className={classes.textGrowVision}>
	     Are you looking to sell your own private label auto parts but not sure where to start? Look no further than brandmyspares.com. Our team of experts has the knowledge and experience to help make your dream a reality. Let us guide you through every step of the process.
	  </div>
      </div>
 ...
 */}
	...
	{/* </div>  */}
       ...
       Revolutionizing automotive solutions, overcoming challenges in every spare part industry, every day.
...
{/* 	   
      ...
      <div className={classes.bottombox}>
        ...
        Join the ranks of forward-thinking businesses each month who opt for excellence in automotive spare parts.
        </div>
        <div className={classes.bdetails}>
        “Begin your success journey with BrandmySpares – become a valued member of our thriving community!" 
        </div>
        <button
